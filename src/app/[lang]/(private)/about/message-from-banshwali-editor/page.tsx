  ...
  return (
    <div className="2xl:container mx-auto my-8 px-4">
      <h1 className="text-3xl font-semibold text-center">
        बंशावली संयोजकको सन्देश
      </h1>

      <div className="rounded mt-6 max-w-5xl mx-auto">
        <div>
          <div className="w-fit mx-auto py-10 text-center">
            <Image
              className="rounded-lg w-[220px] h-[250px] object-cover"
              src="/dummy/boy.jpg"
              alt="literature collection"
              width={200}
              height={180}
            />
            <h2 className="font-semibold text-xl">Rajesh Hamal</h2>
            <p className="text-lg font-medium">बंशावली संयोजक</p>
          </div>
