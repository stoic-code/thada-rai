...
const page = () => {
  ...
  const route = "/merge/mergerequests/received";
              ...
              <TableCell className="flex gap-6 font-medium">
                {req.status === "VERIFIED" ? (
                  ...
                  <Link
                    ...
                    href={`/view-tree?readOnly=true&reqId=${req.id}&mergethis=${req.mergethis}&mergehere=${req.mergehere}&tab=received-merge&claimthis=${req.claimthis}`}
                  >
